...
const OfferPage = () => {
  ...
  <Typography variant="body2" paragraph>
    10.6. Сторони звільняються від відповідальності за повне або часткове невиконання своїх зобов'язань за Офертою у разі, коли таке невиконання було наслідком непереборних обставин, тобто надзвичайних і непередбачуваних обставин за даних умов. До непереборних обставин, зокрема, відносяться: стихійні лиха, воєнні дії, страйки, дії та рішення державних органів влади, виникнення збоїв у телекомунікаційних та енергетичних мережах.
  </Typography>
</Box>
<Box sx={{ my: 2 }}>
  <Typography variant="body1" paragraph>
  ...
  <Typography variant="body2" paragraph>
    11.2. Всі претензії, пов'язані з договором, укладеним за умовами цієї Оферти, повинні бути подані у письмовій формі протягом десяти днів з дати їх виникнення. Претензії, подані після цього терміну, не розглядаються Агентом.
  </Typography>
  ...
  <Typography variant="body2" paragraph>
    12.1. Спори, що виникають у процесі виконання договору за умовами цієї Оферти, вирішуються з дотриманням претензійного порядку. Претензія подається Агенту у письмовій формі з додаванням документів, що обґрунтовують висунуті вимоги, у строк не більше 10 (десяти) календарних днів з дати виникнення причини спору. Отримана претензія розглядається Агентом протягом строку не більше 10 (десяти) календарних днів.
  </Typography>
  <Typography variant="body2" paragraph>
    12.2. У випадку неможливості досягнення згоди, виниклі спори підлягають розгляду в суді за місцезнаходженням Агента.
  </Typography>
  <Typography variant="body2" paragraph>
    12.3. З усіх інших питань, що не передбачені Офертою, Сторони керуються законодавством України.
  </Typography>
